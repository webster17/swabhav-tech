angular.module('studentApiController', [])
    .controller('viewStudentController', ['$rootScope', '$scope', 'dataService', '$window', '$location', '$sce', 'auth', function ($rootScope, $scope, dataService, $window, $location, $sce, auth) {
    ...
    .controller('updateStudentController', ['$rootScope', '$scope', '$window', '$routeParams', 'dataService', '$sce', '$location', '$timeout', 'auth', function ($rootScope, $scope, $window, $routeParams, dataService, $sce, $location, $timeout, auth) {
        $rootScope.logedInUser = auth.check();
        if (!$rootScope.logedInUser.authenticated) {
            $window.localStorage['intendedUrl'] = $location.url();
            $location.path('/login');
    ...
    .controller('authController', ['$rootScope', '$scope', '$sce', 'auth', '$location', '$window', function ($rootScope, $scope, $sce, auth, $location, $window) {
        $rootScope.logedInUser = auth.check();
        ...
        if($window.localStorage['rememberUserName'] != undefined)
            $scope.credential.userName = $window.localStorage['rememberUserName'];
